<template>
  ...
  >
    ...
    <g class="nc-loop_dots-06-32" transform="rotate(45 16 16)">
      ...
      <circle fill="#2CA01C" cx="25.19239" cy="6.80761" r="3" opacity="0.4" />
      <circle fill="#2CA01C" cx="29" cy="16" r="3" opacity="0.4" />
      <circle fill="#2CA01C" cx="25.19239" cy="25.19239" r="3" opacity="0.4" />
      <circle fill="#2CA01C" cx="16" cy="29" r="3" opacity="0.4" />
      <circle fill="#2CA01C" cx="6.80761" cy="25.19239" r="3" opacity="0.4" />
      <circle fill="#2CA01C" cx="3" cy="16" r="3" opacity="0.6" />
      <circle fill="#2CA01C" cx="6.80761" cy="6.80761" r="3" opacity="0.8" />
    </g>
  </svg>
</template>
<script>
